...
export const siteData = {
  ...
  "pages": [
    ...
    },
    {
      "title": "HTML",
      "frontmatter": {},
      "regularPath": "/Note/HTML.html",
      "relativePath": "Note/HTML.md",
      "key": "v-56cd26bc",
      "path": "/Note/HTML.html",
      "headers": [
        {
        ...
        {
          "level": 2,
          "title": "了解即可：只针对于IE浏览器识别使用",
          "slug": "了解即可-只针对于ie浏览器识别使用"
        },
        {
          "level": 2,
          "title": "指定IE浏览器—请使用你最新内核来渲染网页",
          "slug": "指定ie浏览器-请使用你最新内核来渲染网页"
        },
        {
          "level": 2,
          "title": "IE(10%--100%)IE6;IE7(IE6,IE7)",
          "slug": "ie-10-100-ie6-ie7-ie6-ie7"
        },
        {
          "level": 2,
          "title": "html5标准中规定所有外观修饰都要通过CSS完成",
          "slug": "html5标准中规定所有外观修饰都要通过css完成"
        },
        {
          "level": 2,
          "title": "以上两个属性为了了解项目的功能",
          "slug": "以上两个属性为了了解项目的功能"
        },
        {
          "level": 3,
          "title": "文本类型标签  #此类标签中间的内容时文本字符串",
          "slug": "文本类型标签-此类标签中间的内容时文本字符串"
        },
        {
          "level": 2,
          "title": "面试题",
        ...
        {
          "level": 2,
          "title": "默认情况表单将用户数据转换字符串，但是上传文件不能字符串",
          "slug": "默认情况表单将用户数据转换字符串-但是上传文件不能字符串"
        },
        {
          "level": 2,
          "title": "添加附加属性    表单用户数据转换 101010101010101  上传成功  数字合并图片",
          "slug": "添加附加属性-表单用户数据转换-101010101010101-上传成功-数字合并图片"
        },
        {
          "level": 2,
          "title": "day04",
        ...
        {
          "level": 3,
          "title": "3.2：AJAX    -HTTP协议",
          "slug": "_3-2-ajax-http协议"
        },
        {
          "level": 3,
          "title": "3.3：AJAX-DOM知识体系",
          "slug": "_3-3-ajax-dom知识体系"
        },
        {
          "level": 2,
          "title": "day05",
        ...
        {
          "level": 3,
          "title": "2.javascript简单学习DOM",
          "slug": "_2-javascript简单学习dom"
        },
        {
          "level": 2,
          "title": "3.AJAX",
        ...
        {
          "level": 2,
          "title": "2.1.2：如果使用AJAX完成POST",
          "slug": "_2-1-2-如果使用ajax完成post"
        },
        {
          "level": 3,
          "title": "2.1.3:如果使用AJAX完成DELETE",
          "slug": "_2-1-3-如果使用ajax完成delete"
        },
        {
          "level": 2,
          "title": "注意事项",
    ...
    },
    {
      ...
      "headers": [
        {
          "level": 2,
          "title": "EventEmitter的前端实现",
          "slug": "eventemitter的前端实现"
        },
        {
          "level": 3,
          "title": "API",
        ...
        {
          "level": 3,
          "title": "removeListener方法",
          "slug": "removelistener方法"
        },
        {
          "level": 3,
          "title": "once方法",
        ...
        {
          "level": 3,
          "title": "removeAllListener方法",
          "slug": "removealllistener方法"
        },
        {
          "level": 3,
          "title": "setMaxListeners方法和listeners方法",
          "slug": "setmaxlisteners方法和listeners方法"
        },
        {
          "level": 2,
          "title": "ts",
    ...
    },
    {
      "title": "js",
      "frontmatter": {},
      "regularPath": "/Note/js.html",
      "relativePath": "Note/js.md",
      "key": "v-80ea013c",
      "path": "/Note/js.html",
      "headers": [
        {
        ...
        {
          "level": 3,
          "title": "常量（const)：用于存储数据的容器",
          "slug": "常量-const-用于存储数据的容器"
        },
        {
          "level": 3,
          "title": "数据类型",
        ...
        {
          "level": 3,
          "title": "（1）while循环（循环条件为true执行循环体）",
          "slug": "_1-while循环-循环条件为true执行循环体"
        },
        {
          "level": 3,
          "title": "（2）do-while循环（先执行一遍循环体再判断循环条件）",
          "slug": "_2-do-while循环-先执行一遍循环体再判断循环条件"
        },
        {
          "level": 3,
          "title": "（3）for 循环",
    ...
    },
    {
      ...
      "headers": [
        ...
        {
          "level": 2,
          "title": "box-shadow: 5px 10px 10px 0 red,15px 20px 10px 0 green",
          "slug": "box-shadow-5px-10px-10px-0-red-15px-20px-10px-0-green"
        },
        {
          "level": 3,
          "title": "2.光标设置",
        ...
        {
          "level": 2,
          "title": "cover:注意height的大小，容易过大",
          "slug": "cover-注意height的大小-容易过大"
        },
        {
          "level": 3,
          "title": "6.盒子模型",
        ...
        {
          "level": 3,
          "title": "3.不同元素的盒子模型（重点）",
          "slug": "_3-不同元素的盒子模型-重点"
        },
        {
          "level": 3,
          "title": "4.流",
        ...
        {
          "level": 3,
          "title": "1.布局容器container",
          "slug": "_1-布局容器container"
        },
        {
          "level": 2,
          "title": "day17",
    ...
    },
    {
      "title": "VUEUI",
      "frontmatter": {},
      "regularPath": "/Note/VUEUI.html",
      "relativePath": "Note/VUEUI.md",
      "key": "v-1a422b94",
      "path": "/Note/VUEUI.html",
      "headers": [
        {
          "level": 2,
          "title": "typora （markdown编辑器）",
          "slug": "typora-markdown编辑器"
        },
        {
          "level": 2,
          "title": "VUEUI  Vue组件库",
        ...
        {
          "level": 3,
          "title": "/实现ElementUI的经典布局",
          "slug": "实现elementui的经典布局-2"
        },
        {
          "level": 2,
          "title": "MintUI",
        ...
        {
          "level": 3,
          "title": "基于脚手架安装配置MintUI",
          "slug": "基于脚手架安装配置mintui"
        },
        {
          "level": 3,
          "title": "MintUI常用组件",
        ...
        {
          "level": 3,
          "title": "实现项目首页中底部选项卡的设计",
          "slug": "实现项目首页中底部选项卡的设计"
        },
        {
          "level": 3,
          "title": "swipe组件",
        ...
        {
          "level": 3,
          "title": "加载UI类别下（cid=1）的文章首页列表数据",
          "slug": "加载ui类别下-cid-1-的文章首页列表数据"
        },
        {
          "level": 2,
          "title": "VUEUI Unit05",
        ...
        {
          "level": 3,
          "title": "实现切换顶部选项卡时更新文章列表",
          "slug": "实现切换顶部选项卡时更新文章列表"
        },
        {
          "level": 3,
          "title": "实现列表的触底分页加载",
        ...
        {
          "level": 3,
          "title": "将上述代码搬到实现列表的触底分页加载业务",
          "slug": "将上述代码搬到实现列表的触底分页加载业务"
        },
        {
          "level": 3,
          "title": "添加弹等待框功能",
        ...
        {
          "level": 2,
          "title": "HTML5新特性 -- WebStorage",
          "slug": "html5新特性-webstorage"
        },
        {
          "level": 2,
          "title": "WebStorage的基本使用",
          "slug": "webstorage的基本使用"
        },
        {
          "level": 2,
          "title": "WebStorage在数据存储时的一些限制",
          "slug": "webstorage在数据存储时的一些限制"
        },
        {
          "level": 2,
          "title": "基于WebStorage实现用户状态管理",
          "slug": "基于webstorage实现用户状态管理"
        },
        {
          "level": 2,
          "title": "HTML5新特性",
        ...
        {
          "level": 3,
          "title": "audio、video标签的DOM操作",
          "slug": "audio、video标签的dom操作"
        },
        {
          "level": 2,
          "title": "HTML新特性  Unit02",
          "slug": "html新特性-unit02"
        },
        {
          "level": 3,
          "title": "HTML5 Audio/Video 方法",
          "slug": "html5-audio-video-方法"
        },
        {
          "level": 2,
          "title": "Canvas  画布",
        ...
        {
          "level": 3,
          "title": "接入第三方位置服务平台  --  百度地图、高德地图",
          "slug": "接入第三方位置服务平台-百度地图、高德地图"
        },
        {
          "level": 2,
          "title": "HTML新特性  Unit04",
          "slug": "html新特性-unit04"
        },
        {
          "level": 3,
        ...
        {
          "level": 3,
          "title": "DragEvent拖拽相关事件",
          "slug": "dragevent拖拽相关事件"
        },
        {
          "level": 3,
          "title": "基于拖拽操作实现文件上传",
        ...
        {
          "level": 3,
          "title": "网络通信过程中的长连接与短连接",
          "slug": "网络通信过程中的长连接与短连接"
        },
        {
          "level": 3,
          "title": "什么是websocket？",
        ...
        {
          "level": 2,
          "title": "HTML新特性  Unit06",
          "slug": "html新特性-unit06"
        },
        {
          "level": 3,
          "title": "WebSocket 群聊完成了，私聊该如何解决？",
          "slug": "websocket-群聊完成了-私聊该如何解决"
        },
        {
          "level": 2,
          "title": "WebWorker",
        ...
        {
          "level": 3,
          "title": "Worker与主线程之间的通信",
          "slug": "worker与主线程之间的通信"
        },
        {
          "level": 2,
          "title": "SVG",
        ...
        },
        {
          "level": 3,
          "title": "HelloWorld 示例",
          "slug": "helloworld-示例-2"
        },
        {
          "level": 3,
          "title": "基于Echarts对北京二手房数据完成数据可视化",
          "slug": "基于echarts对北京二手房数据完成数据可视化"
        },
        {
          "level": 3,
          "title": "HTTP协议的状态管理",
    ...
    },
    {
      "title": "node",
      "frontmatter": {},
      "regularPath": "/Note/node.html",
      "relativePath": "Note/node.md",
      "key": "v-2ff8f97c",
      "path": "/Note/node.html",
      "headers": [
        {
        ...
        {
          "level": 3,
          "title": "1.Node.js是运行在服务器端的js解释器，基于谷歌的v8引擎",
          "slug": "_1-node-js是运行在服务器端的js解释器-基于谷歌的v8引擎"
        },
        {
          "level": 3,
          "title": "2.全局对象",
        ...
        {
          "level": 3,
          "title": "3.RESTful接口（API）",
          "slug": "_3-restful接口-api"
        },
        {
          "level": 2,
          "title": "day16",
    ...
    },
    {
      "title": "数据库5.8",
      "frontmatter": {},
      "regularPath": "/Note/%E6%95%B0%E6%8D%AE%E5%BA%93.html",
      "relativePath": "Note/数据库.md",
      "key": "v-044ea009",
      "path": "/Note/%E6%95%B0%E6%8D%AE%E5%BA%93.html",
      "headers": [
        {
          "level": 2,
          "title": "(1)聚合查询",
        ...
        {
          "level": 3,
          "title": "左外连接（以左侧的表为主导，所有左侧表的数据都要显示,先写哪个表，哪个就是左）",
          "slug": "左外连接-以左侧的表为主导-所有左侧表的数据都要显示-先写哪个表-哪个就是左"
        },
        {
          "level": 3,
          "title": "右外连接  (以右侧的表为主导，所有右侧表的数据都要显示,后写哪个表，哪个就是右）",
          "slug": "右外连接-以右侧的表为主导-所有右侧表的数据都要显示-后写哪个表-哪个就是右"
        },
        {
          "level": 3,
          "title": "全连接(左侧和右侧所有记录都显示）",
          "slug": "全连接-左侧和右侧所有记录都显示"
        },
        {
          "level": 2,
          "title": "数据库操作",
    ...
    },
    {
      "title": "jscode",
      "frontmatter": {},
      "regularPath": "/Note/jscode.html",
      "relativePath": "Note/jscode.md",
      "key": "v-bf9627fc",
      "path": "/Note/jscode.html",
      "headers": [
        {
          "level": 2,
          "title": "/jscode",
